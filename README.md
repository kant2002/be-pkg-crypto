...
This repository contains the package with tools for encryption and auth.
...
In order to install and use the linked dependencies for `pkg-crypto` the following command can be used:
